    ...
    <section id="Categories" class="container-fluid c">
		<h2>Catégories</h2>
			<div class="row justify-content-center c">
				...
				<div class="col-sm-6 col-md-5 col-lg-4 c">
					<a href="page_animaux.html" class="card c">
	...
	<footer class="container-fluid">
		<div class="row footer">
			...
			<div class="col-sm">
				<div class="wild">
					<div class="col-8">
						<p><img src="https://imagizer.imageshack.com/img923/8125/xjvCju.png" class="logofooter" alt="logo"> 
						<span class="titre"> W</span>ild<span class="titre">B</span>azar</p>
					</div>
				</div>
				<div class="adress">
					<div class="col-7 ">
						<p>1 rue de la Paix<br> 75000 Paris<br> 01-23-45-67-89</p>
					</div>
				</div>
			</div>
